                        ...
                        (EliminacionUciNeo.nuevoRegistro !== null ? [
                            m("input[type='text'][placeholder='HH:mm']", {
                                ...
                                oncreate: (el) => {
                                    ...
                                    if (EliminacionUciNeo.nuevoRegistro.hora !== null) {
                                        el.dom.value = EliminacionUciNeo.nuevoRegistro.hora;
                                    }
                                ...
                                oninput: (e) => {
                                    setTimeout(() => {
                                        try {
                                            ...
                                            if (EliminacionUciNeo.nuevoRegistro.editar != true) {
                            ...
                            m('select.tx-semibold', {
                                ...
                                onkeypress: (e) => {
                                    if (e.keyCode == 13) {
                                        EliminacionUciNeo.nuevoRegistro.numeroTurno = PacientesUCI.numeroTurno;
                                        EliminacionUciNeo.nuevoRegistro.fechaHoraTurno = PacientesUCI.fechaHoraTurno;
                                        EliminacionUciNeo.nuevoRegistro.timestamp = moment(PacientesUCI.fechaHoraTurno, 'DD-MM-YYYY HH:mm').format('DD-MM-YYYY') + ' ' + EliminacionUciNeo.nuevoRegistro.hora;

                                        if (EliminacionUciNeo.nuevoRegistro.tipo == null || EliminacionUciNeo.nuevoRegistro.tipo.length == 0) {
                                            $.alert('El campo Tipo o Valor no puede ser vacio.');
                                        } else if (moment(EliminacionUciNeo.nuevoRegistro.timestamp, "DD-MM-YYYY HH:mm", true).isValid() == false) {
                                            $.alert(EliminacionUciNeo.nuevoRegistro.timestamp + ' El valor de Hora no tiene el formato HH:mm necesario.');
                                        } else if (EliminacionUciNeo.nuevoRegistro.valor == null || EliminacionUciNeo.nuevoRegistro.valor.length == 0) {
                                            $.alert('El campo Tipo o Valor no puede ser vacio.');
                                        } else {
