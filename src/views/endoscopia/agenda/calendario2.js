...
class BadgeAgendasReagendamiento {
                ...
                Calendario.calendarios.map((_v, _i) => {
                    if (_v.TIPO == 1) {
                        if (Calendario.idCalendar !== null) {
                            let _agendas = Calendario.idCalendar.split(',');
                            if (_agendas.includes(_v.IDCALENDAR)) {
                                return m("span.badge.badge-success.mg-r-2", _v.CALENDAR);
                            }
                        }
                    }
                }),
                ...
                m('p.mg-0.pd-0', [
                    Object.keys(Cita.data.calendarios).map((_i) => {
                        if (Cita.data.calendarios[_i].TIPO == 2) {
                            ...
                            }, Cita.data.calendarios[_i].CALENDAR);
                        }
                    }),
                ])
...
class FetchCalendario {
    ...
    static fetch() {
        ...
        // Validar si exite Cita Reagenda
        let _purl = 0
...
class Calendario extends App {
                            ...
                            !Cita.data.editable ? [
                                m("button.btn.btn-xs.btn-primary.mg-r-5[data-dismiss='modal']", {
                                    onclick: () => {
                                        ...
                                        Cita.copiarDatos('CitaReagenda', Cita.data);
                    ...
                    m("div", {
                        ...
                        (Cita.data.tipo == 1 ? [
                            ...
                            m("div", {
                                ...
                                m("div.row", [
                                    m("div.col-6", [
                                        m("label.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1.tx-color-03", "Agenda(s) Cita Actual:"),
                                        m("p", [
                                    ...
                                    m("div.col-6", [
                                        m("label.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1.tx-color-03", "Nueva(s) Agenda(s):"),
                                        m("p", [

                                            m(BadgeAgendasReagendamiento)
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    confirm: {
                                        text: 'Confirmar',
                                        action: function () {
                                            console.log(55, Calendario.calendarios)
                                            m.redraw();
    ...
    static validarAgendamiento(track) {
        ...
        if (track == 'Reagendar') {
            Cita.validarCitaHttp_2(Calendario);
