...
class OptionSelect {
    ...
    static selectInit() {
        ...
        if (OptionSelect.scroll !== null) {
            OptionSelect.scroll.update();

        } else {
            OptionSelect.scroll = new PerfectScrollbar("#calendarSidebarBody", {
...
class Cita {
    ...
    static crearCita(startDate, endDate) {
        ...
        Cita.data.pn_inicio = startDate.format("DD/MM/YYYY HH:mm");
        Cita.data.pn_fin = endDate.format("DD/MM/YYYY HH:mm");
...
class Calendario extends App {
    ...
    static setSidebar() { // Sidebar calendar
        ...
        $("#calendar").fullCalendar({
            ...
            eventRender: function (event, element) {
                ...
                if (event.tipo == 3) {
                    ...
                    element.find(".fc-title").attr("title", "<div class='wd-50px text-left'>" + event.title + "  </div> " + "<br> <div class='wd-50px text-left'>Fecha Y Hora:</div> <div class='wd-50px text-right text-capitalize'>" + moment(event.pn_inicio, "DD/MM/YYYY HH:mm").format("HH:mm") + " - " + moment(event.pn_fin, "DD/MM/YYYY HH:mm").format("HH:mm") + " <br> " + moment(event.pn_fin, "DD/MM/YYYY HH:mm").format("dddd, DD/MM/YYYY") + "  </div> <br> " + "<div class='wd-50px text-left'>Agendas:</div> <div class='wd-50px text-left'>" + _calendarios + "</div>  ");
                }
    ...
    static vMain() {
        return [
            m("div.calendar-wrapper", [
                m("div.calendar-sidebar", [
                    ...
                    m("div.calendar-sidebar-body.ht-auto.pos-relative[id='calendarSidebarBody']", [
                        ...
                        m("div.pd-t-0.pd-l-20.pd-r-20", [
                            ...
                            }, "Filtro Agendas/Calendarios: "), !Calendario.loader && Calendario.citas.status && Calendario.citas.data.length !== 0 ? [m("div.schedule-group", m(OptionSelect))] : [],
                        ]),
                ...
                m("div.calendar-content", [!Calendario.loader && Calendario.citas.status && Calendario.citas.data.length !== 0 ? [
                    m("div.pd-20.mg-b-0", {
                ...
                m("div.modal-body.pd-20.pd-sm-30", [
                    ...
                    m("div", {
                        ...
                        m("div", {
                            ...
                            }, m("label.tx-semibold.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1", "Nombre Evento:"), m("div.input-group", [
                            ...
                            }, m("label.tx-semibold.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1", "Nota:"), m("div.input-group", [
                            ...
                            }, m("label.tx-semibold.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1", "Estudio:"), m("div.input-group", [
                            ...
                            m("div.form-group", {
                                class: Cita.data.tipo == 1 ? "" : "d-none"
                            }, m("label.tx-semibold.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1", "Historia Clínica Paciente: ", m("div.d-inline.tx.semibold.tx-danger", {
                                style: {
                                    cursor: "pointer"
                                },
                                onclick: () => {
            ...
            m(".modal.calendar-modal-event[id='modalCalendarEvent'][role='dialog'][aria-hidden='true']", m(".modal-dialog.modal-dialog-centered.modal-xl[role='document']", m("div.modal-content", [
                ...
                m("div.modal-body", [
                                ...
                                m("div.col-6", [
                                    ...
                                    m("p", [
                                        Cita.data.anios + " Años - " + (
                                            Cita.data.sexType == "M" ? "Masculino" : "Femenino"
                                        ),
                                    ]),
                                ]),
                                m("div.col-6", [
                    ...
                    m("hr"),
                    m("div.text-right", [
                        (Cita.data.tipo !== 3 ? [!Cita.data.editable ? [
                    ...
                    m("div", {
                        ...
                        (Cita.data.tipo == 1 ? [
                            ...
                            m("div", {
                                ...
                                m("div.form-group.d-none", m("label.tx-semibold.tx-uppercase.tx-sans.tx-11.tx-medium.tx-spacing-1", "Tipo:"), m("div.input-group", [
                                    m("div.custom-control.custom-radio", [
                                        ...
                                        m("label.custom-control-label[for='tipoCitaUpdate1']", "Cita Médica"),
                                    ]),
                                    m("div.custom-control.custom-radio.mg-l-20", [
                                        ...
                                        m("label.custom-control-label[for='tipoCitaUpdate2']", "Evento"),
                                    ]),
                                ])),
                                m("div.form-group", [
                                    m("div.row.row-xs", [
    ...
    static filterEventos(parametro) {
        let res = [];
        Calendario.citas.data.events.map((_v, _i) => {
            if (_v.tipo == 2 && moment(_v.pn_inicio, "DD/MM/YYYY HH:mm").unix() > moment().unix() && _i <= 4) {
                res.push(_v);
            }
        });
        return res;
